...
<div class="services-container services-page-container">
    ...
    <?php if (!empty($services)): ?>
        ...
        <?php endforeach; ?>
        <p>If what you're looking for isn't listed above, don't worry! We may offer it. Please call us at <a href="<?php // echo YHI_PHONE ?>"><?php // echo YHI_PHONE ?></a> to ask about our services.</p>  
    <?php else: ?>
